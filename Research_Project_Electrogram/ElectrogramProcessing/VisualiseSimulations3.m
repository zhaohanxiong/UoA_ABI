...
files = dir('C:/Users/zxio506/Desktop/Test10/a*');
nfiles = length(files);

E = zeros([Ny Nx Nz nfiles], 'single');

for j = 1:1:nfiles
    infile = fullfile('C:/Users/zxio506/Desktop/Test10', sprintf('aa%04d.vtk',j));
    fid = fopen(infile, 'r');
...
%% save the data
Vm = single(E);
save('C:\Users\zxio506\Desktop\temp3.mat','Vm','-v7.3');
