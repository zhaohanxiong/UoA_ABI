...
disp('Defining regions for first laplace solve');
...
tissue(endoLA_surface > 0)   = 100; %endo of RA = -100
tissue(epi_surface > 0) = 200;
...
accuracy = 0.001;          % desired relative error (%)
...
disp('saving endo-to-endo laplace solution');
save -v7.3 EndoToEndoLaplaceFieldLines.mat tissue
disp('Complete');
disp('Run Mid Line (9) Script');
%% Second iteration field lines for transmurality

% save outside.mat outside
% save TransmuralFieldLines.mat tissue
